    ...
    <section class="cta-wrapper cta--four" id="categories">
        ...
        <div class="card--thirteen">
         ...
         <div class="col-md-4 col-sm-6 pricing-list-botom-margin wow zoomIn" data-wow-duration="3s">
            ...
            <div class="pricing-list1">
                <div class="pricing-header1">
                    <h5>{{$essential_plan->name}}</h5>
                
                    <p>{{$essential_plan->duration}} Days ({{$essential_plan->time}} months)</p>
                    <br><br>
                    <a href="{{url("plan-details/$essential_plan->slug")}}"><button type="submit" name="register" style="background:none; border:none;">Get Started</button></a>
                </div>
                
                <div class="pricing-info1">
                    <ul>
                        <li> <p>for <span class="color-text">{{ $essential_plan->time }}</span> months</p></li>
                        <li><p> <span class="color-text">{{ $essential_plan->percent }}%</span>ROI</p></li>
                    </ul>
                ...
                <div class="price-range">
                                <div class="row">
                                    <div class="col-md-6 text-left col-sm-6 col-xs-6">
                                        <div class="min-price">
                                            <h6>Available Units<span class="color-text">{{$essential_plan->remaining_units_percent}}%</span></h6>
                                        </div>
                                       
                                    </div>
                                    <div class="col-md-6 text-right col-sm-6 col-xs-6">
                                        <div class="min-price">
                                            <h6>Unit Subscription Price<span class="color-text">₦ {{number_format($essential_plan->price, 2)}}</span></h6>
                                        </div>
                                    </div>
                                </div>
                </div>

        ...
        <div id="rev_slider_15_1" class="rev_slider fullwidthabanner" style="display:none;"
            ...
            <ul>    <!-- SLIDE  -->
                <li data-index="rs-36" data-transition="fade,slotfade-horizontal" data-slotamount="default,default"
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('asset/img/landflipping2.jpeg')}}" alt="" data-bgposition="center center" data-kenburns="on"
                ...
                <li data-index="rs-40" data-transition="boxfade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('asset/img/palmoil.jpeg')}}" alt="" id="particles-js" data-bgposition="center center" data-bgfit="cover"
...
<!--end start investment plan-->
    ...
    <div class="project-pagination m-top-40">
                    ...
                    <div class="pagination-area">
                        <nav aria-label="Page navigation pagination-left">
                            <ul class="pagination justify-content-center">
                                <a class="btn btn-primary btn-lg" href="{{url('insights')}}">See All Insights</a>
                            </ul>
                        </nav>
                    </div><!-- ends: .pagination-wrapper -->
                ...
                @foreach($plan as $p)
                    <div class="col-md-3 col-sm-6 pricing-list-botom-margin wow zoomIn" data-wow-duration="3s">
                        ...
                        <div class="pricing-list1">
                            <div class="pricing-header1">
                                <h5>{{ $p->name }}</h5>
                                <p>{{ $p->compound->name }} {{ $p->percent }}% for {{ $p->time }} months</p>
								<br><br>
								<a href="{{url('register')}}"><button type="submit" name="register" style="background:none; border:none;">Choose Plan</button></a>
                            </div>
							
                            <div class="pricing-info1">
                                <ul>
                                    <li> <p>for <span class="color-text">{{ $p->time }}</span> months</p></li>
                                    <li><p> <span class="color-text">{{ $p->percent }}%</span> roi each month</p></li>
                                </ul>

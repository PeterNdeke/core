...
<!-- Mirrored from aazztech.com/demos/themes/html/tizara/dist/business-conduct.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jan 2020 03:22:27 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
                ...
                <div class="col-md-12">
                    <div class="d-flex topbar_content justify-content-between">
                        ...
                        <div class="top_bar--info order-0 d-none d-lg-block align-self-center">
                            <ul>
                                <li><span class="la la-envelope"></span> <p>support@email.com</p></li>
                                <li><span class="la la-headphones"></span> <p>800 567.890.576</p></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb_wrapper d-flex flex-column align-items-center">
                        <h4 class="page_title">Our Business Conduct</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-bottom-30">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Our Business Conduct</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="d-flex justify-content-center">
                        <li><a href="about-two.html">About Us</a></li>
                        <li><a href="history.html">Our History</a></li>
                        <li><a href="our-values.html">Our Values</a></li>
                        <li><a href="business-conduct.html" class="active">Business Conduct</a></li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 margin-md-60">
                    ...
                    <a href="#" class="btn btn-primary btn-icon icon-right m-top-25">Download PDF <i class="la la-download"></i></a>
                </div><!-- ends: .col-lg-5 -->
                <div class="col-lg-6 offset-lg-1">
                    <img src="img/slide9_1.png" alt="" class="rounded">
                </div><!-- ends: .col-lg-6 -->
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-1">
                    ...
                    <p>Investig ationes demons trave runt lectores legere lius quod ii legunt saepius claritas nvestig ationes demons trave rungt. Investiga tiones demonstr averunt lectores legere me lius quod ii qua legunt saepius. Claritas est etiam pro cessus dynamicus, qui sequitur mutationem.</p>
                ...
                <div class="col-lg-6 margin-md-60">
                    ...
                    <p>Investig ationes demons trave runt lectores legere lius quod ii legunt saepius claritas nvestig ationes demons trave rungt. Investiga tiones demonstr averunt lectores legere me lius quod ii qua legunt saepius. Claritas est etiam pro cessus dynamicus, qui sequitur mutationem.</p>
                    <a href="#" class="btn btn-outline-secondary mt-4">Read More</a>
                </div><!-- ends: .col-lg-6 -->
                <div class="col-lg-5 offset-lg-1">
                    <img src="img/cb2.jpg" alt="">
                </div><!-- ends: .col-lg-5 -->
                <div class="col-lg-12">
                    <hr class="hr">
                </div>
                <div class="col-lg-5 margin-md-60">
                    <img src="img/cb6.jpg" alt="">
                </div><!-- ends: .col-lg-5 -->
                <div class="col-lg-6 offset-lg-1">
                    <h4>Business Change Transformation</h4>
                    <p>Investig ationes demons trave runt lectores legere lius quod ii legunt saepius claritas nvestig ationes demons trave rungt. Investiga tiones demonstr averunt lectores legere me lius quod ii qua legunt saepius. Claritas est etiam pro cessus dynamicus, qui sequitur mutationem.</p>

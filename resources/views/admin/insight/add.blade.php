        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body" style="overflow: hidden">
                    {!! Form::open(['method'=>'post','url' => 'admin/insights','class'=>'form-horizontal','files'=>true,'novalidate'=>'']) !!}
                    <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group mb15">
                                            <input class="form-control input-lg bold" name="title" value="" required type="text" placeholder="Title">
